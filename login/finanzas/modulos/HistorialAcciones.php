...
<body>
          ...
          <tbody id="tablaBody">
            ...
            <?php else: foreach ($logs as $log): 
                ...
                switch($log['operation']) {
                    case 'Inserción': $badgeClass = 'badge-insertar'; break;
                    case 'Actualización': $badgeClass = 'badge-actualizar'; break;
                    case 'Eliminación': $badgeClass = 'badge-eliminar'; break;
                }
            ?>
  ...
  <script>
    function aplicarFiltros() {
        ...
        window.location.href = `index.php?mod=HistorialAcciones&op=${op}&fecha=${fecha}`;
    }
